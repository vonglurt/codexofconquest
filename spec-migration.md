...
The roll2hit.com combat tracker was designed as a DM-assist tool: a fast, opinionated interface for tracking initiative, attack rolls, damage, conditions, and death saves during combat. Its architecture — a single HTML file, all JavaScript and CSS inlined, no runtime dependencies — made it deployable by simply opening a file in a browser.
