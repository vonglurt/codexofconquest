...
- [ ] **§MESH-01-FU — remaining follow-ups** (small; numbering preserved from the archived checkpoint list; 7 ✅ publish-bootstrap.sh 2026-07-06 → archived):
