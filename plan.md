...
**§WALK-4** — CI-gated invariant suite (I1/I2/I3 reachability proof + walk-parity) and rebuild the stale Playwright nav tests (stale since §WALK-1.5; see §WALK-1.5-FU(e)).
