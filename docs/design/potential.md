...
1. **Nothing here is scoped work.** Promoting a seed = a new `§` row in [BACKLOG.md](../backlog/BACKLOG.md); anything that grows to a chain/faction/system also needs a `lab-reports/lab-report-*.md` **before any HTML edit** (Lab Report Policy).
