...
| `world.md` | DM manual: world history, 4 factions, 7 Epic NPC profiles, quest motivation, survival pressure | ✅ Reviewed 2026-05-24 · **Layers 56 + 57 promoted `⚠️ PLANNED` → `✅` 2026-08-25 (§AUDIT-03ak)**, both live and both already ✅ in `story.md`; **one `⚠️ PLANNED` heading remains that names a partly-live layer — Layer 59, §DX-02hg** |
