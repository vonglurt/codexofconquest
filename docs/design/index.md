...
| Metric | Value | Status |
|--------|-------|--------|
| HTML line count | 38,977 | ✅ 2026-09-06 (`wc -l play.html`) — **−4 from §DX-02di** (the `_VOID_TERRAIN_RE` declaration and the four lines of its two call sites, less the comment and one-line return that replaced them). Prior: **−4 from §DX-02dl increment 2**, **+7 from §DX-02dl increment 1** |
