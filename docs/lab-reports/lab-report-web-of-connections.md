...
| VI | Training log | ✅ | Full log, Bruna's entries, the two-year gap, player entries keyed to `pitTrainingWins`, plus a Layer 64 championship entry. **F5 closed 2026-09-07 (§DX-02fg)** — the stage direction is four authored entries; **its header closed 2026-09-08 (§DX-02jq)** — the title names Weckmann, not the `crov` key. `CY Fighting Pit` remains, as §DX-02jr |
