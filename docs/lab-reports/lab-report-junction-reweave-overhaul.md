...
|---|---|---|---|
| §5 | **P_NUKE** nuclear cull, 6 phases | ✅ **SHIPPED `e2576f6`, live at HEAD** | `src/js/wbapi-server.js:6629–6882`; `src/api/wb.js:1416`; both cite this file by name |
...
- `lab-report-cell-map-mud-redesign.md` — §CELL-05, which delivered §12's forecast by a
  different route
- `src/js/wbapi-server.js:6629` · `src/api/wb.js:1416` — P_NUKE as shipped, both citing this file
