...
`vaCI: false, vaSL: false, vaDF: false, vaWM: false, vaMT: false,@23134` and
`vaAllMarksFound: false, vaLogFound: false@23135` — nine booleans, all declared in `_S_DEFAULTS()`,
