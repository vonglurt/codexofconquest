...
| 9 | **§7 step 1 — XP goes through `S_story.xp` then `_checkLevelUp()`** | **SHIPPED** | The `reward` handler does exactly this: `if (E.checkLevelUp) E.checkLevelUp(); }@22271`, wired at `checkLevelUp: () =>@22348`. |
