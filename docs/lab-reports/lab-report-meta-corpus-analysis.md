...
|---|---|---|
| Files in `docs/lab-reports/` at 14:19:02 | **71** | `git ls-tree -r faddace -- docs/lab-reports/` |
...
*"(archived)"* — but the file was present in `docs/lab-reports/` at `7d3615a` and is present at HEAD. It was
