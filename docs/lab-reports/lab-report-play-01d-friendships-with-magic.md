...
**Parent review:** `docs/lab-reports/lab-report-play-review.md` §PLAY-01-D ·
...
3. Census the magic-gear grant paths with the real parser (`src/js/wbapi-core.js`, `W.load`) and
