...
**Parent:** `docs/lab-reports/lab-report-terrain-field-mover-redesign.md` (the §WALK coordinate system this refuses to change)
...
claim about 2026-06-26), reconstructing the projection from `GEO2` + `src/config/walk-geo-gazetteer.json` with
