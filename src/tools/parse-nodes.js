...
/**
 * parse-nodes.js — CodexOfConquest.com NODE_MAP parser
 *
 * Reads play.html, extracts NODE_MAP and NODE_COORDS,
...
const HTML_FILE = path.join(__dirname, '..', '..', 'play.html');  // repo ROOT (tools/ is one level down)
...
// ── Build record array ────────────────────────────────────────────────────────
const DIST_THRESHOLD = 3; // matches play.html
