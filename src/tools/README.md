...
| File | What it does |
|------|--------------|
| `worldmap.js` | Terminal ASCII world-map views. Spawned by `./api.sh worldmap [--city/--region/--search/--route]` (path wired in `../api/wb.js`); also runnable directly: `node src/tools/worldmap.js --regions`. |
