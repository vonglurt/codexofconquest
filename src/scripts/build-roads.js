...
// out of play.html, connects every settlement cell (distinct occupied
...
const GAME_PATH = path.join(ROOT, 'play.html');
...
const pinsPath = path.join(ROOT, 'src', 'config', 'roads-pins.json');
...
console.log(`\n✓ ROAD_RUNS block ${GAME.includes(START) ? 'replaced' : 'inserted'} in play.html`);
