...
| [x] | MAN | ivanhoe | Ivanhoe — Sir Walter Scott | 1819 (Norman Eng.) | Historical Novel | 1140 | SEEDS COMPLETE 2026-06-03 — MAN-01–07 all vignettes done (7 cycles). questComplete added to MAN-07 (cycle 7). New nodes: SHF, HMT added to Location Grid (AHB, NRG, ROT, TPR already existed). Theme threads for all 7 cycles. See MAN-ivanhoe.md. |
