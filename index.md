...
| **§NAV-01** | Navigable World: MUD-coherent map + fungal road net — **IN PROGRESS: Inc a–d ✅** (pos-origin BFS, `ROAD_RUNS` net 400 cells / 88 junctions, `describeCell` room layer, road-weighted auto-travel) + map suite + GLOBE panel. Remaining: Inc e wayfinding UI, Inc f MUD room parity, Inc g/h worldbuilder drag-&-lock + road-net editor. Spec: `plan.md §NAV-01`. |
