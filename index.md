...
| Live entity counts | **Run `npm run stats` for live totals** (§DX-01g — parsed from the data sections by `wbapi-core`, the single source; don't trust a hardcoded count). Last measured 2026-07-28: 416 nodes (418 − J14/J15, retired by §DX-01a) · 398 monsters · 111 terrains · 2,853 quests (§AUDIT-03f restored `quest_sea_01`/`quest_sb_01` to the parse — the count was an undercount, not new content) · 204 NPC profiles · 213 dialogues · 8 acts · 37,948 lines · 5.46 MB | ✅ 2026-07-28 (`npm run stats`) |
