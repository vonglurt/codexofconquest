...
This is **exactly [§VM-01](BACKLOG-2-engine-systems.md#vm-01--the-quest-vm--no-word-for-wait-new-2026-07-16), already open, already the active track** — *"the VM has an opcode table and no jump instruction."* This pass adds independent confirmation from the content side and **two findings §VM-01 does not name**:
