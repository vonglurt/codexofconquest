    ...
    const HELP = {
      ...
      import: {
        ...
        body: [
          ...
          '  Node codes = IATA airport code of nearest major airport.',
          '  If taken, use nearest alternate. If no airport: derive from city name + add to index.md.',
          ...
          '',
          'STEP 8 — Review unresolved items with user, then save and repeat',
          ...
          `    curl -XPOST ${b}/api/save`,
          '  Then return to Step 1 for the next act / next vignette cycle.',
          '',
          'IMPORT QUEUE',
