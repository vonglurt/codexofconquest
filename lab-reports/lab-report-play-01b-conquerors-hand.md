...
**Parent:** `lab-reports/lab-report-play-review.md` §PLAY-01-B · **Track:** BACKLOG.md §PLAY-01 (face **B** of *The Honest Floor*)
...
| 51 | Census with the real parser, never a line regex | `js/wbapi-core.js` `W.load(GAME)` over `MONSTER_POOL` and `NODE_MAP` |
| 70 | Re-run the report's own acceptance test | `tests/integration/enemy-ai.test.js` — 4/4 |
...
> `js/wbapi-core.js`, confirmed live in a browser at a neutral node.
...
| 2 | `tests/integration/enemy-ai.test.js` at scripted HP | ✅ **4/4 in 3.5 s** — helpers, press-once, flee-closes-fight, full-HP regression |
...
- **Ship:** `8eb909e` 2026-07-12 12:40:44 — `roll2hit-v3.html` +77, `tests/integration/enemy-ai.test.js` +112,
