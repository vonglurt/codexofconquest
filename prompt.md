...
```bash
npm run check:walk        # 13 world-invariant CI gates (invariants/dupkeys/parity/behaviour/terrain/roads/rooms/quest/gate/rng/questgraph/nodeindex/noderegs)
...
**Known pre-existing baseline reds: `check:walk` is fully green (13/13; 11/11 since 2026-07-28 §DX-01a, gate #12 added 2026-07-29 §AUDIT-03l, gate #13 added 2026-07-31 §AUDIT-03j) — any red there is a real regression you introduced. The Playwright suite carries FOUR, all in ONE file** — a full run is **710 passed / 4 failed**, last re-proved **2026-07-30** (§DX-02f). This list is the whole red set; **anything beyond these four is yours**:
